...
// temp solution, hard code
import annOpen from "../../public/images/announcements/open.png";
import annClose from "../../public/images/announcements/closed.png";
...
export default function Announcements() {
	...
	return (
		<div className="font-aquire pt-[3em]">
			...
			<section className="mx-[3em] my-10 flex h-fit min-h-[100vh] flex-col lg:mx-[8em]">
				...
				<div className="flex flex-col gap-4">
					{announcements.map((item) => (
						<div key={item.id} className="">
							...
							<Image src={item.content} alt={item.title} quality={30} priority style={{ objectFit: "cover" }} />
						</div>
					))}
				</div>
			</section>
