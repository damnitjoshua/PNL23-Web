...
async function Page({
  ...
  params: { categoryId: string; yearId: string; roundId: string };
}) {
              ...
              {contestants.map((contestant, index) => {
                ...
                return (
                  <tr
                    ...
                    className="h-12 bg-white bg-opacity-25"
                  >
